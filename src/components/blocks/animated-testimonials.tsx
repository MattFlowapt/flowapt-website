      ...
      <div className="container mx-auto max-w-5xl px-4 sm:px-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="relative h-full min-h-[350px] md:min-h-[400px]">
            ...
            {/* Decorative elements */}
            <div className="absolute -bottom-6 -left-6 h-24 w-24 rounded-xl bg-gray-400/10"></div>
            <div className="absolute -top-6 -right-6 h-24 w-24 rounded-xl bg-gray-400/10"></div>
          </motion.div>
        </motion.div>
      </div>
    </section>
